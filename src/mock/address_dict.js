export const C_REGION = ['东北', '华北', '华东', '华中', '华南', '西南', '西北'];
...
export const REGION = ['大台北', '桃竹苗', '中彰投', '雲嘉嘉', '南高屏澎', '東部', '金馬'];
...
export const EN_REGION = ['Northeast', 'Southeastern', 'Midwestern', 'Northwestern', 'Western'];
...
export const EN_DICT = (function() {
	const result = [];
	for (let key in EN_DICT_RAW) {
		const list = EN_DICT_RAW[key];
		const children = [];
		for (let i = 0; i < list.length; ++i) {
			children[i] = { name: list[i] };
		}
		result.push({
			name: key,
			children,
